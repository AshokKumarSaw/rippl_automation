...
Feature: Ways to Earn program Creation
  ...
  Scenario Outline: Verify build from scratch feature in ways to earn
    ...
    And selects  <startdate>, <enddate>,<filterByTags>,<tracking_instruction> and uploads the banner image
    ...
    Examples: 
      | email                          | password    | name                      | short_description                           | action_description                                                                                                                                                                                                                                                                                                                                                               | startdate    | enddate      | filterByTags | tracking_instruction | reward_points | water_saved | plastic_saved | Trees_planted | optional_email_settings        | content | correlated_task          |
