...
public class BuildFromScratch {
	...
	public void verify_created_challenge_contains_exactly_the_same_details_filled_in_the_form_during_creation(
			String challenge_name, String short_description,String action_description,String startdate, String enddate, String filterByTags,
			String tracking_instruction,String reward_points, String water_saved, String plastic_saved,
			String Trees_planted,String optional_email_settings, String content,
			String correlated_task) {
		buildFromScratchPage.verifyChallengeDetails(challenge_name,short_description,action_description,startdate,  enddate, filterByTags,
				tracking_instruction, reward_points, water_saved, plastic_saved,
				Trees_planted,optional_email_settings,content,
				 correlated_task);
