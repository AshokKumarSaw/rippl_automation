...
Feature: Ways to Earn program Creation
  ...
  Scenario Outline: Verify build from scratch feature in ways to earn
    ...
    Examples: 
      | email                          | password    | name                      | short_description                           | action_description                                                                                                                                                                                                                                                                                                                                                               | startdate    | enddate      | Filter_by_customer_tags | image_tracking_type  | reward_points | water_saved | plastic_saved | Trees_planted | optional_email_settings        | content | correlated_task          |
      | "abhik.khandelwal01@gmail.com" | "Rippl@321" | "Fitness Bingo challenge" | "Engage in a variety of fitness activities" | "Participants will receive a bingo card with various fitness-related activities in each square, such as jogging for 30 minutes, completing a yoga session, or doing 50 push-ups. They must complete these activities to mark off the corresponding squares on their card. The goal is to achieve a bingo pattern (horizontal, vertical, or diagonal) within the given timeframe" | "20-05-2024" | "25-05-2024" | "base_tier"             | "Live image capture" | "1"           | "1"         | "1"           | "1"           | "abhik.khandelwal01@gmail.com" | "test"  | "Drink a glass of water" |
